function [spectrogram, amplitude_spectrum, stoch_surf, window_size, chat_cos, chat_sin, num_cons]=...
...
% 2) amplitude_spectrum - amplitude spectrum
% 3) stoch_surf   - The stochastis surface at (1-alpha) confidence level
%                   NOTE: The stochastic is valid when normalized = true
% 4) window_size  - The sizes of translating windows
% 5) chat_cos     - The estimated cosine coefficients for segments 
% 6) chat_sin     - The estimated sine coefficients for segments
% 7) num_const    - The numbers of constituents of known forms within 
...
%--------------------------------------------------------------------------
% amplitude spectrum
% be sure to define a clim[] or a ylim[] that is not too close to 0
amplitude_spectrum = (sqrt(abs(chat_cos).^2 + abs(chat_sin).^2));
